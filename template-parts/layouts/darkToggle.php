<button id="theme-toggle" type="button" class="hidden lg:inline-flex" >
  <svg id="iconLight" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" class="w-5 fill-gray-400 hover:fill-white hidden">
  ...
  <svg id="iconDark" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" class="w-5 fill-gray-400 hover:fill-gray-900 hidden">
